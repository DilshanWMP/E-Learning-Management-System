    ...
    <>
      ...
      <BodyContent>
        ...
        <section className="bgimage">
          <div className="content" style={{ alignItems: 'flex-end' }}>
            <h1 style={{ color: 'white' }}>
              Bring your <br />
              goals<span style={{ color: '#DF8AA3' }}> into <br />focus</span>
            </h1>
            <br />
            <p style={{ textAlign: 'right', color: 'white' }}>
              CodeDot offers online courses and programs
              <br /> that prepare you for every career moment
            </p>
          </div>
        </section>
        ...
        <div className="container">
          <SmallCard imgSrc={icon1} title="Artificial Intelligence" />
          <SmallCard imgSrc={icon2} title="Computer Programming" />
          <SmallCard imgSrc={icon3} title="Machine Learning" />
          <SmallCard imgSrc={icon4} title="Statistics" />
        </div>
        ...
        <div
          ...
          style={{
            padding: '0px 100px',
            background:
              'linear-gradient(to top right, rgba(10, 37, 42, 1), rgba(10, 37, 42, 0.83)',
          }}
        >
          <Features
            imgSrc={image1}
        ...
        <div
          className="content"
          style={{ backgroundColor: 'white', padding: '0px 100px' }}
        >
          <Features
            imgSrc={image2}
        ...
        <div
          className="content centered-text"
          style={{
